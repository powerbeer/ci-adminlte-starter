...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            extErrorStr: "ชนิดไฟล์ไม่ถูกต้อง: ",
            duplicateErrorStr: " ไฟล์นี้ถูกอัปโหลดขึ้นไปแล้ว.",
            sizeErrorStr: " ไฟล์มีขนาดเกินกำหนด : ",
            uploadErrorStr: "ฟังชั่นการอัปโหลดยังไม่เกิดให้บริการ",
            maxFileCountErrorStr: " จำนวนไฟล์ที่อัปโหลดมีมากเกินไป :",
            downloadStr: "ดูเอกสาร",
	...
	this.enqueueFile = function(file){
        ...
        this.createProgress = function (filename,filename_th,filepath,filesize) {
            
           // console.log(filename + '/'+filename_th+'/'+  filepath +'/'+filesize);
            ...
            if(s.showFileCounter)
            	fileNameStr = obj.fileCounter + s.fileCounterStyle + filename_th;
            else fileNameStr = filename_th;
